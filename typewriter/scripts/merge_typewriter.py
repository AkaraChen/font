...
Family naming: "CourierPrimeZhuque Dual" intermediate / "CourierPrimeZhuque NFM" product.
"""
...
def main() -> int:
    ...
    p.add_argument("--family", default="CourierPrimeZhuque Dual")
    p.add_argument("--family-ps", default="CourierPrimeZhuqueDual")

#!/usr/bin/env python3
"""Render 荷塘月色 mixed CJK/EN coding sample for AKR Round SC."""
...
def main() -> int:
    ...
    ap.add_argument(
        "--font",
        type=Path,
        default=root / "out" / "nerd" / "AKRRoundSCNFM-Regular.ttf",
    )
    ap.add_argument("--out-dir", type=Path, default=root / "samples" / "rendered")
    ap.add_argument("--title", default="AKR Round SC NFM · EN 500 / CJK 1000 · Iosevka Curly × RHR")
